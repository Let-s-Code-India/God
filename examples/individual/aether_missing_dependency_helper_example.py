"""Standalone aether.missing_dependency_helper example."""
...
def main() -> None:
    ...
    member = getattr(aether, "missing_dependency_helper")
    ...
    summary = {"library": "aether", "member": "missing_dependency_helper", "count": len(records)}
